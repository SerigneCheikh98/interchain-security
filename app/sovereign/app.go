...
func New(
	...
	// ibcRouter.AddRoute(consumertypes.ModuleName, consumerModule) WARN: possible breakage due to sovereign/consumer
	...
	// WARN: possible breakage due to commenting this out
